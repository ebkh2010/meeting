...
- **نسخهٔ سند:** ۱.۰ | **تاریخ:** 2026-08-17 | **تهیه‌کننده:** Emma (مدیر محصول)
...
- **معماری سیستم (Bob):** بر پایهٔ بخش‌های ۵.۱، ۶.۱ و ۶.۳ این سند — با تمرکز بر مدل چندمستأجری، لایهٔ Adapter سرویس AI، صف کار غیرهمزمان و طراحی Storage/ایندکس.
