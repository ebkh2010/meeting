...
> **وضعیت پیاده‌سازی (به‌روزرسانی ۱۴۰۵/۰۶/۱۶ — v1.0.26):** این سند مرجع
> تصمیم‌های محصولی است و اکنون سیستم پیاده و روی تولید مستقر است. زنجیرهٔ اصلی
> (جلسه → دستور → دعوت → آپلود → رونویسی «حرف» → پیش‌نویس DeepSeek → گردش تأیید
> و قفل → مصوبات/اقدامات → خروجی Word/ICS → آرشیو → اعلان → جست‌وجو → داشبورد)
> کامل پیاده شده و علاوه بر آن این قابلیت‌ها اضافه شده‌اند: پنل مدیریت پلتفرم
> (تعریف مدیر سازمان با پیامک، تنظیمات هر سازمان، سطل آشغال)، واحد یکپارچهٔ
> «توکن ویدارا»، جست‌وجوی تمام‌متن با فیلتر محدوده و پرش به بخش یافت‌شده،
> چند فایل صوتی با ترتیب دلخواه، آپلود ویدیو با جداسازی خودکار صدا، نام‌گذاری
> گوینده‌ها با کلیپ صدا، تنظیمات تولید صورت‌جلسه به‌ازای هر جلسه، دستیار هوشمند
> با منابع واقعی، و پیام خطای صریح برای هر شکست آپلود. جلسات تکرارشونده و تقویم
> گرافیکی همچنان در فاز بعد هستند.
