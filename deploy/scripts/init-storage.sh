...
# --------------------------------------------------------------------------
# خودترمیمی سرویس SSH (idempotent — با هر استقرار خودکار اجرا می‌شود)
# اگر sshd از کار افتاده باشد، این بخش آن را برمی‌گرداند. هیچ قانون فایروالی
# در اینجا اعمال نمی‌شود؛ مدیریت فایروال به‌صورت دستی/توسط مالک انجام می‌شود.
# --------------------------------------------------------------------------
