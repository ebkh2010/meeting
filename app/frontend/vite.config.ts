...
// برند محصول ثابت است و نباید با متغیرهای محیطی پلتفرم (OVERVIEW_*) بازنویسی شود.
process.env.VITE_APP_TITLE = 'ویدارا - نسخه جلسات';
process.env.VITE_APP_DESCRIPTION ??=
  process.env.OVERVIEW_DESCRIPTION ?? 'نرم‌افزار هوشمند مدیریت جلسات، توسعه داده شده توسط تیم ویدارا.';
process.env.VITE_APP_TITLE = escapeHtmlAttr(process.env.VITE_APP_TITLE);
process.env.VITE_APP_DESCRIPTION = escapeHtmlAttr(process.env.VITE_APP_DESCRIPTION);
process.env.VITE_APP_LOGO_URL = '/assets/vidara-logo-horizontal.png';
