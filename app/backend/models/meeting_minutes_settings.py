"""تنظیمات تولید صورتجلسهٔ هر جلسه (ترجیحات محتوایی همان جلسه).
...
- ``generate_items`` — آیا مصوبات و اقدامات هم تولید شوند؟ (پیش‌فرض: بله)
...
class Meeting_minutes_settings(Base):
    __tablename__ = "meeting_minutes_settings"
    ...
    generate_items = Column(Boolean, nullable=True)
