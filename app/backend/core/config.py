...
class Settings(BaseSettings):
    ...
    # احراز هویت و امضای توکن (مقادیر از ENV خوانده می‌شوند؛ پیش‌فرض‌ها امن‌اند)
    jwt_secret_key: str = ""
    jwt_algorithm: str = "HS256"
    jwt_expire_minutes: int = 15

    # AI پلتفرم — در استقرار مستقل اختیاری است (هر سازمان تأمین‌کنندهٔ خودش را دارد)
    app_ai_base_url: str = ""
    app_ai_key: str = ""

    # OIDC پلتفرم — فقط در محیط پلتفرم استفاده می‌شود
    oidc_issuer_url: str = ""
    oidc_client_id: str = ""
